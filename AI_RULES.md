...
## 9. Preservation of Intellectual Capital (CRITICAL)
- **Non-Destructive Documentation**: **NEVER** overwrite, delete, or "clean up" existing technical sections (e.g., "How The Math Works", "Architectural Intent") or previous rules in this document unless explicitly directed by Management. 
...
- **Rule Protection**: This specific rule (Rule 9) applies most strictly to the `AI_RULES.md` itself.
